		...
		$.ajax({
			...
			success : function(data){						
				...
				for(index in board.boardFiles){
					html += "<a onclick=downloadFunc('"+board.boardFiles[index].tempFileName+"','"+board.boardFiles[index].fileName+"')>"+board.boardFiles[index].fileName+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"</a></br>";
				}
				html += "</td>";
				html += "</tr>";
				$("#DetailTable").empty();
	...
	function deleteBoard(){
		...
		$.ajax({
			...
			success : function(data){
				...
				alert(data.errorMsg);
				location.href="${pageContext.request.contextPath}/logiinfo/boardList/view"
