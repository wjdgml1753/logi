...
<article class="contractMpsGrid">
    <div align="center">
        <div id="myGrid" class="ag-theme-balham" style="margin-bottom: 20px; height:30vh; width:auto; text-align: center;"></div>
    </div>
</article>
<!-- div>
    <h5>📷 공정 계획</h5>
...
<article class="salesMpsGrid">
    <div align="center" class="ss">
        <div id="myGrid2" class="ag-theme-balham" style="height:20vh;width:auto;"></div>
    </div>
</article>
