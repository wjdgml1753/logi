...
/////////////////////////////////////////if문/////////////////////////////////////////////
            ...
            if (selectedNodes != undefined) {
                selectedNodes.map(selectedData => {
                    selectedData.data.reverseType = to.detailCode;
                    selectedData.data.reverseTypeName = to.detailCodeName;
                })
            }

            returnAbleListGridOptions.api.redrawRows(selectedNodes);
        }
////////////////////////////////////////////////////////////////////////////////////////
